...
/**
 * This class is modified to call PISOccurence, for the runninb of the 
 * PISRuleGrowth algorithm.
...
public class Rule {
	...
	Set<Integer> tidsJ;
	Set<Integer> tidsIJ;
	Map<Integer, PISOccurence> occurencesI;
	Map<Integer, PISOccurence> occurencesJ;
